const lat = -33.43107481500285;
const long = -70.62097167231357;
...
const getServices = async stopId => {
    ...
    return (response === null || response === void 0 || (_response$predictions = response.predictions) === null || _response$predictions === void 0 ? void 0 : _response$predictions.map(x => ({
        route: x === null || x === void 0 ? void 0 : x.route,
        distanceLabel: x === null || x === void 0 ? void 0 : x.distanceLabel,
        timeLabel: x === null || x === void 0 ? void 0 : x.timeLabel,
        distance: x === null || x === void 0 ? void 0 : x.distance,
        licensePlate: x === null || x === void 0 ? void 0 : x.licensePlate
    }))) || [];
};
...
const createServices = stops => stops.reduce((acc, curr) => {
    acc[curr.stopId] = curr.servicios.reduce((accServicio, currServicio) => {
        ...
        accServicio[currServicio.route] = accServicio[currServicio.route] ? accServicio[currServicio.route] + ' - ' + info : info;
        return accServicio;
    }, {});
    return acc;
}, {});
const response = await fetchData(paraderos);
let listadoParaderos = response.map(item => ({
    stopId: item.stop_id,
    name: item.name,
